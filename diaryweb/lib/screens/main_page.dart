...
import 'package:diaryweb/model/Diary.dart';
import 'package:diaryweb/model/user.dart';
import 'package:diaryweb/services/service.dart';
import 'package:diaryweb/widgets/create_profile.dart';
import 'package:diaryweb/widgets/diary_list_view.dart';
import 'package:diaryweb/widgets/write_diary_dialog.dart';
              ...
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  final usersListStream = snapshot.data!.docs.map((docs) {
                    ...
                    print(muser.uid == FirebaseAuth.instance.currentUser!.uid);
                    return (muser.uid ==
                        FirebaseAuth.instance.currentUser!.uid);
                  }).toList();
                  print(usersListStream.length);

                  MUser curUser = usersListStream.elementAt(0);
